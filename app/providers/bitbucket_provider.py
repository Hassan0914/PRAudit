...
logger = setup_logger("providers.bitbucket")


class BitbucketProvider(BaseSCMProvider):
    ...
    def post_inline_comment(
        ...
        logger.info("Posted Bitbucket comment on %s PR #%d (%s:%d)", repo_identifier, pr_number, file_path, line)
        return {"status": "posted", "provider": self.provider_type, "id": 303}
